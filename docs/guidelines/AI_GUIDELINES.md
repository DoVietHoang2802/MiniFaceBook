...
Sử dụng chuẩn **Conventional Commits** với nội dung mô tả viết bằng **tiếng Việt không dấu** (ví dụ: `feat: them am thanh thong bao realtime`, `docs: cap nhat tien do du an`):
`<type>: <description>`
