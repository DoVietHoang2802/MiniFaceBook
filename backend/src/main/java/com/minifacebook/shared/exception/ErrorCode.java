...
public enum ErrorCode {
  UNCATEGORIZED_EXCEPTION(
      9999, "Đã có lỗi xảy ra, vui lòng thử lại sau", HttpStatus.INTERNAL_SERVER_ERROR),
  ...
  INVALID_CREDENTIALS(1028, "Email hoặc mật khẩu không chính xác", HttpStatus.UNAUTHORIZED),
  ...
  REFRESH_TOKEN_EXPIRED(
      1015, "Phiên đăng nhập đã hết hạn, vui lòng đăng nhập lại", HttpStatus.UNAUTHORIZED),
  MAX_UPLOAD_SIZE_EXCEEDED(
      1016, "Kích thước tệp vượt quá giới hạn cho phép (Tối đa 5MB)", HttpStatus.BAD_REQUEST),
  INVALID_FILE_TYPE(
      1017,
      "Định dạng tệp không hợp lệ. Chỉ chấp nhận ảnh JPG, PNG, WEBP và GIF.",
  ...
  // ===== FRIENDSHIP (Phase 3) =====
  CANNOT_FRIEND_SELF(
      2001, "Bạn không thể tự gửi lời mời kết bạn cho chính mình", HttpStatus.BAD_REQUEST),
  FRIEND_REQUEST_EXISTED(
      2002, "Đã tồn tại một lời mời kết bạn giữa hai người", HttpStatus.BAD_REQUEST),
  ...
  INVALID_REQUEST_STATUS(
      2008, "Lời mời kết bạn này không còn ở trạng thái chờ", HttpStatus.BAD_REQUEST),
  ...
  NOT_A_PARTICIPANT(
      3002, "Bạn không phải là thành viên của cuộc hội thoại này", HttpStatus.FORBIDDEN),
  ...
  INVALID_RESET_TOKEN(
      1023, "Mã xác thực đổi mật khẩu không hợp lệ hoặc đã hết hạn", HttpStatus.BAD_REQUEST),
